import { buildScheduleNotificationPage } from './schedule-notification-keyboard.util';

describe('buildScheduleNotificationPage', () => {
  it('splits a page into three columns and returns adjacent pages', () => {
    const page = buildScheduleNotificationPage(
